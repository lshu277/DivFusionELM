function [IW, B, LW, TF, TYPE, Info] = elmtrain_DivFusionELM(P, T, N, TF, TYPE, cfg)
...
addpath(fullfile(currentFilePath, 'src'));
addpath(fullfile(currentFilePath, 'plot'));
...
cfg = divfusionelm_default_config(cfg);
